    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logo.png') }}" alt="logo_uz" width="50" height="50">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <?php $usage = Auth::user()->usage_count ?>
                <p class="text-lg {{ $usage <= 0 ? 'text-red-500' : 'text-green-500'}}">{{ __('(Left usages: ') . ($usage <= 0 ? '0' : $usage) . __(')')}}</p>
